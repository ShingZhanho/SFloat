...
public class ArithmeticOperationsTests {
    ...
    public void AdditionTest(string numA, int baseA, string numB, int baseB, string expected) {
        // Arrange
        var a = new JacobS.SFloat.SFloat(numA, baseA);
        var b = new JacobS.SFloat.SFloat(numB, baseB);
    ...
    public void MultiplicationTest(string numA, int radixA, string numB, int radixB, string expected) {
        // Arrange
        var a = new JacobS.SFloat.SFloat(numA, radixA);
        var b = new JacobS.SFloat.SFloat(numB, radixB);
    ...
    public void DivisionTest(string numA, int radixA, string numB, int radixB, string expected, int maxFracLength = JacobS.SFloat.SFloat.MAX_DEFAULT_FRAC_LENGTH) {
        // Arrange
        var a = new JacobS.SFloat.SFloat(numA, radixA, maxFracLength);
        var b = new JacobS.SFloat.SFloat(numB, radixB, maxFracLength);
